...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Treasure: "+ treasureCollection,width/2 ,100);
  }
...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(0, width),40, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(0, width),40, 10, 10));
...
function createJwellery() {
  ...
  var jwellery = createSprite(Math.round(random(0, width),40, 10, 10));
